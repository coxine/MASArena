...
class TextExtractionCollection(ActionCollection):
    ...
    def __init__(self, arguments: ActionArguments) -> None:
        ...
        print("Text Extraction Service initialized")
            ...
            for fallback_encoding in fallback_encodings:
                if fallback_encoding != target_encoding:
                    try:
                        ...
                        print(f"Successfully read with fallback encoding: {fallback_encoding}")
    ...
    def mcp_extract_text_content(
        ...
        try:
            ...
            print(f"Processing text document: {file_path.name}")
            ...
            if extraction_result["encoding_info"]["is_binary"]:
                print("Warning: File appears to contain binary data")

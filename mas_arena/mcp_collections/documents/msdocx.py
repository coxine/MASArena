...
class DOCXExtractionCollection(ActionCollection):
    ...
    def __init__(self, arguments: ActionArguments) -> None:
        ...
        print("DOCX Extraction Service initialized")
            ...
            with zipfile.ZipFile(file_path, "r") as docx_zip:
                ...
                for idx, media_file in enumerate(media_files):
                    try:
                        ...
                        print(f"Extracted {media_type}: {media_filename}")
    ...
    def _convert_doc_to_docx(self, doc_path: Path) -> Path:
        ...
        if docx_path.exists():
            print(f"Using existing converted file: {docx_path.name}")
            return docx_path

        print(f"Converting .doc to .docx: {doc_path.name}")
        ...
        try:
            ...
            if docx_path.exists():
                print(f"Conversion successful: {docx_path.name}")
                return docx_path
            else:

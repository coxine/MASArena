...
class WikipediaCollection(ActionCollection):
    ...
    def mcp_get_article_content(
        ...
        try:
            ...
            print(f"📖 Retrieving Wikipedia article: {title} (language: {language})")
    ...
    def mcp_get_article_summary(
        ...
        try:
            ...
            print(f"📝 Retrieving summary for: {title} (language: {language})")
            ...
            print(f"✅ Retrieved summary for: {title}")
...
# Add missing Color class for _color_log method
class Color:
    red = "\033[31m"
    green = "\033[32m"
    yellow = "\033[33m"
...
def _color_log(message, color=None):
...
if __name__ == "__main__":
    ...
    # Initialize and run the Wikipedia service
    try:

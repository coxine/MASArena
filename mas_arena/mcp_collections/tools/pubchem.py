...
class PubChemCollection(ActionCollection):
    ...
    def __init__(self, arguments: ActionArguments) -> None:
        ...
        self.session.headers.update(
            {"User-Agent": "MASARENA", "Accept": "application/json"}
        )

        print("PubChem MCP Service initialized")
    ...
    def mcp_search_compounds(
        ...
        try:
            ...
            print(f"Searching PubChem for: {query} (type: {search_type})")
            ...
            print(f"Found {len(compounds)} compounds ({response_time:.2f}s)")
    ...
    def mcp_get_compound_synonyms(
        ...
        try:
            ...
            print(f"Retrieving synonyms for CID: {cid}")
            ...
            print(f"Retrieved {len(synonyms)} synonyms ({response_time:.2f}s)")
            ...
            print(f"❌ Synonym retrieval failed: {str(e)}")
            return ActionResponse(
                success=False,
    ...
    def mcp_get_compound_properties(
        ...
        try:
            ...
            print(f"Retrieving properties for CID: {cid}")
            ...
            print(f"Retrieved {len(compound_props)} properties ({response_time:.2f}s)")
            ...
            print(f"❌ Property retrieval failed: {str(e)}")
            return ActionResponse(
                success=False,
    ...
    def mcp_search_similar_compounds(
        ...
        try:
            ...
            print(f"Searching for compounds similar to CID: {cid}")
            ...
            print(f"Found {len(similar_compounds)} similar compounds ({response_time:.2f}s)")

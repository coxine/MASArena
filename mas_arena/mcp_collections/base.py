...
class ActionArguments(BaseModel):
    ...
    workspace: str | None = Field(
        ...
        " If not specified or invalid, the workspace will be read from the environment variable",
    )
...
class ActionCollection:
    ...
    def _obtain_valid_workspace(self, workspace: str | None = None) -> Path:
        ...
        Priority:
          ...
          3. home directory
        """
        path = Path(workspace) if workspace else os.getenv("MASARENA_WORKSPACE", "~")
